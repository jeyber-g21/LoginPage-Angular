...
exports.deleteTask = exports.putCheckbox = exports.getUserTasks = exports.createTask = exports.getUserMeetings = exports.createMeeting = exports.resetPassword = exports.forgotPassword = exports.loginUser = exports.registerUser = void 0;
...
const registerUser = async (req, res) => {
    try {
        ...
        const user = await user_model_1.default.create({ email, name, lastName, password: hashed });
        res.status(201).json({
